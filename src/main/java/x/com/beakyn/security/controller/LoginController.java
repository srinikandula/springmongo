...
public class LoginController {
    ...
    public String processSubmit(@ModelAttribute("customer") User userForm,
                                BindingResult result,
                                SessionStatus status,
                                HttpSession session) {

        loginValidator.validate(userForm, result);

        String returnStr = "accountLogin";
        ...
        if (!result.hasErrors()) {
            ...
            try {
                ...
                AuthenticationRequest request = new UsernamePasswordRequest(userForm.getUserName(), userForm.getPassword());
                ...
                User dbCustomer = userDAO.findOneByUserName(userForm.getUserName());
                if (dbCustomer == null) {
                    userDAO.save(user);
                }
